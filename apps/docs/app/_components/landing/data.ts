...
export const landingCopy = {
  ...
  zh: {
    ...
    agentics: {
      kicker: "这次新加的能力",
      title: "v0.1.31 新增了语音输入、自审、原生网络搜索以及可配置的 agent 行为。",
      body: "本次发布带来了四种能力面，让你可以更稳地控制 agent 的动作。",
      features: [
        {
          title: "自审工作流",
          icon: "review",
          accent: "blue",
          body: "Best-of-N 编排 + 多视角审计：多份方案并行提出、互相打分，最终挑选风险最小的执行。",
          bullets: [
            "Best-of-N 方案选择",
            "高风险改动审计",
            "内置 verify_solution",
        ...
        },
        {
          ...
          icon: "mic",
          accent: "orange",
          body: "桌面端 composer 一键按住说话;边说边看实时文本,确认无误后再发送。",
          bullets: [
            "渲染层直接调用 Web Speech API",
            "实时转写预览",
            "transcript disclosure 面板",
            "可切换多语言",
          ],
          href: "/docs/features/desktop-voice",
        },
        {
          ...
          icon: "search",
          accent: "violet",
          body: "Provider 路由的 web 搜索,结果以引用 chip 直接插入工具流,推理链路完整可审计。",
          bullets: [
            "Provider 端 web_search 工具",
            "URL + 摘要的内联引用",
            "带缓存的失败重试",
            "工具流直接落点",
          ],
