---
title: Runtime Flow
description: Follow a user message through InfiniteCode.
---

This page follows one normal user prompt through InfiniteCode.
...
The server delegates agent execution to `infinitecode-core`.
...
Interactive sessions persist enough metadata and records for `infinitecode resume` and
