	...
	const inner = (
		<>
			...
			<form className={cn("w-full", className)} onSubmit={handleSubmit} ref={formRef} {...props}>
				<InputGroup className="overflow-hidden has-[[data-slot=input-group-control]:focus-visible]:border-input has-[[data-slot=input-group-control]:focus-visible]:ring-0 has-[[data-slot=input-group-control]:focus-visible]:ring-transparent">
					{children}
				</InputGroup>
			</form>
		</>
...
export const PromptInputTextarea = ({
	...
	return (
		<InputGroupTextarea
			className={cn(
				"field-sizing-content max-h-48 min-h-16 text-foreground placeholder:text-muted-foreground/50",
				className,
			)}
			name="message"
