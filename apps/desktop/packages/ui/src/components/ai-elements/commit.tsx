...
const fileStatusStyles = {
	added: "text-diff-addition-foreground",
	deleted: "text-diff-deletion-foreground",
...
export const CommitFileAdditions = ({
	...
	return (
		<span className={cn("text-diff-addition-foreground", className)} {...props}>
			{children ?? (
				<>
...
export const CommitFileDeletions = ({
	...
	return (
		<span className={cn("text-diff-deletion-foreground", className)} {...props}>
			{children ?? (
				<>
