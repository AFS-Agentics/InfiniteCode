export function InfiniteCodeSplashBrand({ className = "" }: { className?: string }) {
	const classes = ["infinitecode-splash-brand", className].filter(Boolean).join(" ")

	return (
		<span className={classes} role="img" 		aria-label="InfiniteCode">
			<span className="infinitecode-splash-brand-mark-frame" aria-hidden="true">
				<svg
					viewBox="0 0 128 128"
					fill="none"
					xmlns="http://www.w3.org/2000/svg"
					className="infinitecode-splash-brand-mark infinitecode-brand-mark-attention"
				>
			...
			<span aria-hidden="true" className="infinitecode-brand-word infinitecode-brand-word-attention">
