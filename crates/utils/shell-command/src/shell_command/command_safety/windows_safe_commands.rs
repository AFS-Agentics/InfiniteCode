use crate::shell_command::command_safety::is_dangerous_command::git_global_option_requires_prompt;
use crate::shell_command::command_safety::powershell_parser::PowershellParseOutcome;
use crate::shell_command::command_safety::powershell_parser::parse_with_powershell_ast;
use std::path::Path;
...
mod tests {
    use super::*;
    use crate::shell_command::powershell::try_find_pwsh_executable_blocking;
    use std::string::ToString;
