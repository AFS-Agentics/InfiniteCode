    ...
    for change in &patch {
        ...
        files.push(json!({
            ...
            "content": match change.kind {
                PatchKind::Add | PatchKind::Move | PatchKind::Update => new_content.clone(),
                PatchKind::Delete => old_content.clone(),
            },
            "oldContent": old_content.clone(),
            "preContent": old_content.clone(),
            "pre_content": old_content,
            "postContent": new_content.clone(),
