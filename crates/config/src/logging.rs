...
/// enum is part of InfiniteCode's persisted configuration schema.
...
pub struct LoggingFileConfig {
    /// The directory used for persisted log files. Relative paths resolve under `INFINITECODE_HOME`.
